...
class Model_LPGNN(TargetModelInterface):
    ...
    def train_model(self):
        ...
        print(f"TRAINING LPGNN MODEL: ex {self.eps_x} ey {self.eps_y}")
        ...
        print(f"LPGNN Number of features: {data.num_node_features}")
        print(f"LPGNN Number of classes: {data.num_classes}")
